  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 rounded-l-lg border border-zinc-700 bg-zinc-900 px-3 py-1.5 text-sm text-zinc-100 placeholder-zinc-500 focus:border-brand-500 focus:outline-none"
      />
