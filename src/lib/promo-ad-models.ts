...
export const PROMO_AD_MODEL_CATALOG: PromoAdModelInfo[] = [
  {
    ...
    pricingSourceUrl: "",
    description:
      "Stitches approved clips with crossfades, color normalization, optional Ken Burns, per-source watermark removal, and animated brand intro/outro. No generative API cost.",
  },
  {
    id: "nova-reel-1-1",
    label: "Nova Reel 1.1",
